...
def linear_base_func(v: Tensor, u: Tensor, index: int, parents: Tensor, coeffs: Tensor) -> Tensor:
...
def make_random_nonlinear_func(input_dim: int, output_dim: int, n_nonlinearities: int) -> callable:
